...
namespace MyFuelTracker.Infrastructure
{
	public static class ColorHelper
	{
		...
		public static Color GetColor(double currentValue, double minValue, double avgValue, double maxValue)
		{
			...
			var color = new HslColor { A = 1, H = currentValueHue, L = 0.5, S = 1 }.ToColor();
			return color;
		}
